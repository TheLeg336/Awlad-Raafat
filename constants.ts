...
export const TEXTS: Record<string, Record<string, string>> = {
  en: {
    ...
    footer_new_minya_branch_address: 'Corner Plaza Mall, 3rd Floor, Third District',
    footer_phone_title: 'Contact Us',
    footer_phone_placeholder: 'Phone: +20 123 456 7890',
  ...
  ar: {
    ...
    footer_new_minya_branch_address: 'مول كورنال بلازا، الدور الثالث، الحي الثالث',
    footer_phone_title: 'اتصل بنا',
    footer_phone_placeholder: 'الهاتف: +20 123 456 7890',
